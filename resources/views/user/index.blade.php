                ...
                <div class="col-md-8   ">
                    <div class="bg-white shadow mb-3">
                        <div class="card-body " id="jumbotron">
                            <a href="{{ route('user.dashwboard') }}">Dashboard</a>
                            ...
                            <div id="productList">
                                <div class="row">
                                    @foreach ($userProducts as $userProduct)
                                        @php
                                            $product = App\Models\Product::where('id', $userProduct->product_id)->first();
                                        @endphp
                                        <div class="col-md-4">
                                            <div class="shadow p-2 mb-3 text-center">
                                                <img src="{{ asset($product->image) }}" alt="" height="120px" class="img-fluid">
                                                <hr>
