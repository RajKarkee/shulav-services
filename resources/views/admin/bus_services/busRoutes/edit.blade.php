<!-- admin/busRoutes/edit.blade.php -->
            ...
            <div class="modal-body">
                <form id="editForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="distance" id="edit_distance" class="form-control" step="0.01" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="edit_estimated_time">Estimated Travel Time (hours)</label>
                        <input type="number" name="estimated_time" id="edit_estimated_time" class="form-control" step="0.5" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="edit_fare">Base Fare</label>
                        <input type="number" name="fare" id="edit_fare" class="form-control" step="0.01" required>
                    </div>
