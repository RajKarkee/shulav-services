...
@endsection
@section('page-option')
    <button type="button" class="btn btn-primary" data-toggle="modal" onclick="showAdd()">Add Menu</button>
@endsection
@section('s-title')
    <li class="breadcrumb-item">Item Menus</li>
@endsection
@section('content')
    ...
    @include('admin.restaurant.menu.add')
    @include('admin.restaurant.menu.edit')
@endsection
...
@section('script')
    ...
    <script>
        ...
        function loadData() {
                axios.get('{{ route('admin.restaurant.menu.loadData') }}')
                    .then((res) => {
       ...
       function delData(id){
        if(confirm('Are you sure ?')){
            axios.post('{{ route('admin.restaurant.menu.delete') }}',{id:id})
                .then((res) => {
