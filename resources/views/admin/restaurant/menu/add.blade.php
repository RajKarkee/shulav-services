                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="1" name="timetodeliver" id="timetodeliver" class="form-control" >
                            </div>
                        ...
                        <div class="col-md-4" id="addimage">
                            <input type="file" class="dropify" name="logo" id="image" data-default="">
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script >
        function showAdd(){
         ...
         function addSave(){
            ...
            axios.post('{{route('admin.restaurant.menu.index')}}',fd)
            .then((res)=>{
