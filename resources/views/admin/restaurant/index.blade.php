...
@endsection
@section('page-option')
    <button type="button" class="btn btn-primary" data-toggle="modal" onclick="showAdd()">Add Restaurant</button>
@endsection
@section('s-title')
...
@section('content')
    ...
    @include('admin.restaurant.add')
    @include('admin.restaurant.edit')
@endsection
...
@section('script')
    ...
    <script>
        ...
        function loadData() {
                axios.get('{{ route('admin.restaurant.loadData') }}')
                    .then((res) => {
