<div class="footer">
    <div >
        <div style="max-width: 100%" class="logo mb-2">
            <img src="http://localhost:8000/uploads/setting/gV8o2QDBUA5RBL4hov7iY3iNlua4H3vDZGkA3W40.png" alt="">
        </div>
    </div>
    <hr>
    <div class="row">
        <div class="col-md-3 footer-single">
            ...
            <a href="" class="mobile-logo">
                <img src="http://localhost:8000/front/palystore.svg" class="w-100" alt="">
            </a>
        ...
        <div class="col-md-3 footer-single">
            ...
            <div class="subtitle mb-2 text-justify">
                ...
                <form id="subscribe" action="http://localhost:8000/subscribe" class="subscribe shadow">
                    <input type="hidden" name="_token" value="8SsS4ewczkznCthkk4gCgzCHubMZm9COmR4QvY1a" autocomplete="off">                    <input type="email" required placeholder="Enter Email Address">
                    <button>
