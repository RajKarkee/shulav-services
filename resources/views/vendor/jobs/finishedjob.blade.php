                                ...
                                @endphp
                                    <div class="col-md-12">
                                        <div class="bg-white shadow mb-3 p-4">
                                            {{-- <img src="/{{ $job->image }}" style="height: 100px;" alt=""> <br> --}}
                                            ...
                                            <div>
                                                <div class="text-start">
                                                    ...
                                                    <strong>Payment Status : <span class="text-{{ $payment->status==2?'success':'danger'}}">{{ $payment->status==2?'Received':'Not Receive'}}</span></strong><br>
                                                    @if ($payment->status==2 && $payment->received==0)
                                                        <strong>Yes, I Received a Payment. <a href="{{ route('vendor.receivedAPayment',$payment->id)}}" onclick="return confirm('Are you sure?');">Confirm Now</a></strong>
                                                    @endif
                                                </div>
                                                <div class="text-end">
